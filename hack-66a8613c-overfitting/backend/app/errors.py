...
MESSAGES = {
    ...
    'processing_failed': 'Подготовка аудио завершилась ошибкой. Проверьте локальное окружение.',
    'interrupted': 'Подготовка прервана перезапуском приложения. Загрузите запись повторно.',
