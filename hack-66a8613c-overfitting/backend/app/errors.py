...
MESSAGES = {
    'invalid_edits': 'Проверьте поля правок: допустимы имена спикеров, поля поручений и утверждение.',
    'entity_not_found': 'Спикер или поручение не найдено в этой встрече.',
